        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand" href="/">
                    <img src="{{ asset('landing/assets/img/logo.jpg') }}" width="60px" class="black-logo" alt="image">
                    {{-- <img src="{{ asset('landing/assets/img/logo.jpg') }}" width="60px" class="white-logo" alt="image"> --}}
                </a>
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="/user/pengaduan" class="nav-link">
                                Pengaduan
                            </a>
                        </li>
