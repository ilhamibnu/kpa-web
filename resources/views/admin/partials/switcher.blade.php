                        ...
                        <div class="skin-body">
                            <div class="switch_section">
                                ...
                                <div class="switch-toggle">
                                    <a class="bg-img1" onclick="bgImage(this)" href="javascript:void(0);"><img src="{{ asset('admin/assets/img/media/bg-img1.jpg') }}" id="bgimage1" alt="switch-img"></a>
                                    <a class="bg-img2" onclick="bgImage(this)" href="javascript:void(0);"><img src="{{ asset('admin/assets/img/media/bg-img2.jpg') }}" id="bgimage2" alt="switch-img"></a>
                                    <a class="bg-img3" onclick="bgImage(this)" href="javascript:void(0);"><img src="{{ asset('admin/assets/img/media/bg-img3.jpg') }}" id="bgimage3" alt="switch-img"></a>
                                    <a class="bg-img4" onclick="bgImage(this)" href="javascript:void(0);"><img src="{{ asset('admin/assets/img/media/bg-img4.jpg') }}" id="bgimage4" alt="switch-img"></a>
                                </div>
                            </div>
                        </div>
                    </div>
